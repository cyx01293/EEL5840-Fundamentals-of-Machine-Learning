...
dataTest = np.load('image_allChar.npy')
labelTest = np.load('label_allChar.npy')
...
#bb=np.reshape(dataView[13],(32,32))
#plt.figure()
#plt.imshow(bb,cmap='Greys')
#
#plt.show()
#np_decoded_data = dataTestDecoded.data.numpy()
#cc=np.reshape(np_decoded_data[13],(32,32))
#plt.figure()
#plt.imshow(cc,cmap='Greys')
#
#plt.show()
#scipy.misc.imsave('b5.png', cc)
#scipy.misc.imsave('boriginal.png', bb)